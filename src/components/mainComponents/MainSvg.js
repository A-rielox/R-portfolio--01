...
const float1 = keyframes`
   ...
   50% { transform: translateY(15px) translateX(35px) }
...
const File1 = styled.g`
   animation: ${float1} 8s ease infinite;
`;
const File2 = styled.g`
   animation: ${float2} 8s ease infinite;
`;
const File3 = styled.g`
   animation: ${float3} 8s ease infinite;
`;
...
const MainSvg = props => {
   return (
      <svg
         ...
         data-name="Layer 1"
         // width={941.404}
         // height={435.42} jajajaj le puse estos en el viewBox y YAAAA!!!!
         viewBox="0 0 941.404 435.42"
         {...props}
      >
         <path
            d="m84.494 414.524-1.268-.475c-.278-.105-27.992-10.724-40.975-34.8-12.983-24.077-6.625-53.066-6.56-53.356l.3-1.32 1.266.475c.279.105 27.992 10.723 40.975 34.8 12.983 24.077 6.626 53.066 6.56 53.355ZM44.33 378.128c10.976 20.357 32.877 30.792 38.426 33.174 1.055-5.947 4.364-29.997-6.603-50.334-10.965-20.335-32.874-30.786-38.425-33.174-1.056 5.951-4.364 29.999 6.602 50.334Z"
            fill="#3f3d56"
         />
         <path
         ...
         />
         <path
            d="M798.85 5.362H538.68V0H420.71v5.362H159.468a17.599 17.599 0 0 0-17.599 17.599v356.252a17.599 17.599 0 0 0 17.599 17.599H798.85a17.599 17.599 0 0 0 17.598-17.599V22.961a17.599 17.599 0 0 0-17.598-17.599Z"
            fill="#3f3d56"
         />
         <path fill="#664894" d="M165.464 36.464h627.391v353.913H165.464z" />
         <circle cx={478.623} cy={20.377} r={6.435} fill="#664894" />
         <path
            d="M756.838 81.507h-29.74v-29.74h29.74Zm-28.447-1.293h27.154V53.06H728.39ZM834.065 383.942h-61.23v-4.412a.875.875 0 0 0-.874-.874h-20.993a.875.875 0 0 0-.875.874v4.412h-13.12v-4.412a.875.875 0 0 0-.875-.874h-20.993a.875.875 0 0 0-.875.874v4.412h-13.12v-4.412a.875.875 0 0 0-.875-.874h-20.993a.875.875 0 0 0-.875.874v4.412h-13.12v-4.412a.875.875 0 0 0-.875-.874H643.38a.875.875 0 0 0-.874.874v4.412h-13.121v-4.412a.875.875 0 0 0-.875-.874h-20.993a.875.875 0 0 0-.874.874v4.412h-13.12v-4.412a.875.875 0 0 0-.876-.874h-20.993a.875.875 0 0 0-.874.874v4.412h-13.12v-4.412a.875.875 0 0 0-.876-.874H392.34a.875.875 0 0 0-.875.874v4.412h-13.12v-4.412a.875.875 0 0 0-.875-.874h-20.993a.875.875 0 0 0-.875.874v4.412h-13.12v-4.412a.875.875 0 0 0-.875-.874h-20.993a.875.875 0 0 0-.874.874v4.412h-13.121v-4.412a.875.875 0 0 0-.875-.874H284.75a.875.875 0 0 0-.874.874v4.412h-13.12v-4.412a.875.875 0 0 0-.876-.874h-20.992a.875.875 0 0 0-.875.874v4.412h-13.12v-4.412a.875.875 0 0 0-.875-.874h-20.993a.875.875 0 0 0-.875.874v4.412h-13.12v-4.412a.875.875 0 0 0-.875-.874h-20.993a.875.875 0 0 0-.875.874v4.412h-40.236a20.993 20.993 0 0 0-20.993 20.993v9.492a20.993 20.993 0 0 0 20.993 20.993h698.014a20.993 20.993 0 0 0 20.993-20.993v-9.492a20.993 20.993 0 0 0-20.993-20.993Z"
            fill="#3f3d56"
         />
         <path
            fill="#3f3d56"
         ...
         <path
            fill="#2f2e41"
            d="m449.365 379.018-25.797-4.67 8.367-53.864 25.796 4.67-8.366 53.864zM483.527 329.824l25.796 4.67-8.367 46.217-25.796-4.67z"
         />
         <ellipse
            cx={626.082}
            cy={611.196}
         ...
         {/* mouth */}
         {/* <motion.g variants={mouth} whileHover="end"> */}
         <motion.path
            variants={mouth}
            whileHover="end"
            d="M458.993 294.855a19.662 19.662 0 0 0 38.694 7.005c1.934-10.685-6.327-14.466-17.012-16.4s-19.748-1.29-21.682 9.395Z"
            fill="#fff"
         />
         ...
         <File2>
            ...
            <path fill="#664894" d="M262.272 304.361h38.437v38.437h-38.437z" />
            <path
